...
_LEARNINGRATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cosine_restart_learning_rate', full_name='object_detection.protos.LearningRate.cosine_restart_learning_rate', index=4,
...
_COSINERESTARTLEARNINGRATE = _descriptor.Descriptor(
  name='CosineRestartLearningRate',
  full_name='object_detection.protos.CosineRestartLearningRate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='initial_learning_rate', full_name='object_detection.protos.CosineRestartLearningRate.initial_learning_rate', index=0,
      number=1, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='first_decay_steps', full_name='object_detection.protos.CosineRestartLearningRate.first_decay_steps', index=1,
      number=2, type=13, cpp_type=3, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='t_mul', full_name='object_detection.protos.CosineRestartLearningRate.t_mul', index=2,
      number=3, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='m_mul', full_name='object_detection.protos.CosineRestartLearningRate.m_mul', index=3,
      number=4, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='alpha', full_name='object_detection.protos.CosineRestartLearningRate.alpha', index=4,
      number=5, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LEARNINGRATE.fields_by_name['cosine_restart_learning_rate'].message_type = _COSINERESTARTLEARNINGRATE
...
_LEARNINGRATE.oneofs_by_name['learning_rate'].fields.append(
  _LEARNINGRATE.fields_by_name['cosine_restart_learning_rate'])
_LEARNINGRATE.fields_by_name['cosine_restart_learning_rate'].containing_oneof = _LEARNINGRATE.oneofs_by_name['learning_rate']
...
DESCRIPTOR.message_types_by_name['CosineRestartLearningRate'] = _COSINERESTARTLEARNINGRATE
...
CosineRestartLearningRate = _reflection.GeneratedProtocolMessageType('CosineRestartLearningRate', (_message.Message,), dict(
  DESCRIPTOR = _COSINERESTARTLEARNINGRATE,
  __module__ = 'object_detection.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:object_detection.protos.CosineRestartLearningRate)
  ))
_sym_db.RegisterMessage(CosineRestartLearningRate)
