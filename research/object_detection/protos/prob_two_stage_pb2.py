...
_PROBABILISTICTWOSTAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='weight_method', full_name='object_detection.protos.ProbabilisticTwoStage.weight_method', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='add_weight_as_outputv1', full_name='object_detection.protos.ProbabilisticTwoStage.add_weight_as_outputv1', index=3,
