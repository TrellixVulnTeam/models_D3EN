...
_PROBABILISTICTWOSTAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='add_weight_as_output', full_name='object_detection.protos.ProbabilisticTwoStage.add_weight_as_output', index=3,
